      ...
      <div className="p-3">
        <div className="flex justify-between">
          ...
          <div className="flex w-5/12 mt-5">
            <div className="" onClick={showAll}> {all ? <Button value={"All Members"} /> : <ButtonAlt value={"All Members"} />}  </div>
            <div className="ml-5" onClick={showNew}> {newm ? <Button value={"New Membes"} /> : <ButtonAlt value={"New Membes"} />} </div>
            <div className="ml-5" onClick={showAbsent}> {absent ? <Button value={"Abscent Members"} /> : <ButtonAlt value={"Abscent Members"} />} </div>
