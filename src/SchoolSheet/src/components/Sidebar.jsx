	...
	return (
		<div className="bg-white h-screen text-primary2 my-2 -mt-1  shadow-xl">
			...
			<div className="h-[75vh] overflow-y-auto -mt-5">
				...
				<DashboardLinks Icon={FaMoneyCheckAlt} name="Tithe & Offertory" link={"/schedule"} />
				<DashboardLinks Icon={BsPencilFill} name="Notes" link={"/notes"} />
				<DashboardLinks Icon={BsPeopleFill} name="Testimonies" link={"/schedule"} />
				<DashboardLinks Icon={FaPrayingHands} name="Prayer Requests" link={"/schedule"} />
				<DashboardLinks Icon={FaNewspaper} name="News" link={"/schedule"} />
